...
(map! :leader
      (:prefix ("=" . "open file")
       :desc "Go to Trash" "g t" #'(lambda () (interactive) (find-file "~/.local/share/Trash"))
       ...
       :desc "Edit zshrc" "c z" #'(lambda () (interactive) (find-file "~/.dotfiles/zsh/zshrc.org"))
       :desc "Edit vimrc" "c v" #'(lambda () (interactive) (find-file "~/.dotfiles/vim/vimrc.org"))
       :desc "Edit starship" "c s" #'(lambda () (interactive) (find-file "~/.dotfiles/starship/.config/README.org"))
       :desc "Edit lynx" "c l" #'(lambda () (interactive) (find-file "~/.lynx/lynx.org"))
       :desc "Edit polybar folder" "f p" #'(lambda () (interactive) (find-file "~/.config/polybar/"))
...
(after! org
  (setq org-directory "~/.org/"
        ...
        '((sequence "TODO(t)" "DOING(i!)" "WAIT(w@)" "|" "DONE(d!)")
          (sequence "PROJ(p)" "STARTED(s!)" "DELAYED(y@)" "|" "ACCOMPLISHED(a@)")
          (sequence "|" "CANCELLED(c@)" "FAILED(f@)"))))
#+END_SRC
...
This is an example to how you can setup template choice when you use a two letter selection.
...
'(
("p" "Description")
("pf" "first template" plain
;; either in conf template org syntax \n for line breaking
"%?"
;; or
(file "/path/to/file.org")
     :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n")
     :unnarrowed t)
("ps" "second template" plain
;; either in conf template org syntax \n for line breaking
"%?"
;; or
(file "/path/to/file.org")
...
#+begin_src emacs-lisp
(map! :leader
      :desc "org-roam-find-file" "m m f" #'org-roam-node-find
      :desc "org-roam-node-insert" "m m I" #'org-roam-node-insert
      :desc "org-roam-node-insert-immediate" "m m i" #'org-roam-insert-immediate
      :desc "org-roam-db-sync" "m m s" #'org-roam-db-sync
      ;; :map org-mode-map
      ;; :i "M-i" #'org-roam-insert-immediate
      :desc "my/org-roam-find-project" "m m p" #'my/org-roam-find-project
      :desc "my/org-roam-capture-task" "m m t" #'my/org-roam-capture-task
      :desc "my/org-roam-capture-inbox" "m m b" #'my/org-roam-capture-inbox
      :desc "my/org-roam-open-inbox" "m m B" #'my/org-roam-open-inbox)
